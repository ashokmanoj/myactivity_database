...
-- ── Distance: get all (with GPS haversine distance) ───────────────────────────
...
BEGIN
    ...
    SELECT
        ...
        dt.vehicle_type, dt.state, dt.district,
        dt.start_image_id,
        ...
        dt.rate_per_km, dt.required_amount,
        dt.verifier_amount, dt.rm_amount, dt.approved_amount,
        dt.verifier_status, dt.verifier_by, dt.verifier_comment, dt.verifier_at,
        dt.rm_status, dt.rm_by, dt.rm_comment, dt.rm_at,
        dt.ta_status, dt.ta_by, dt.ta_comment, dt.ta_at,
        dt.is_submitted, dt.submitted_at,
        dt.payment_status, dt.payment_by, dt.payment_at,
        dt.uuid,
        COALESCE((
            SELECT COUNT(*)::BIGINT FROM distance_messages dm
