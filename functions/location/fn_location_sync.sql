-- Function: fn_location_sync  |  Domain: location
CREATE OR REPLACE FUNCTION fn_location_sync(p_user_id INT, p_name VARCHAR, p_type VARCHAR, p_lat NUMERIC, p_lon NUMERIC, p_address VARCHAR, p_pincode VARCHAR, p_desc VARCHAR, p_inst_id INT)
