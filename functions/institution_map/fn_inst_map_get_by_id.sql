-- Function: fn_inst_map_get_by_id  |  Domain: institution_map
CREATE OR REPLACE FUNCTION fn_inst_map_get_by_id(p_id INT)
...
BEGIN
  ...
  WHERE m.institute_project_map_id = p_id AND m.is_active = 1;
END;
$$ LANGUAGE plpgsql;