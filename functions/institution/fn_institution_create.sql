...
BEGIN
  RETURN QUERY INSERT INTO instituation (institution_name, institute_code, project_id, district_id, block_id, address, pincode, latitude, longitude, is_active, created_at, updated_at)
