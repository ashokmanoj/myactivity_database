...
RETURNS TABLE(institute_id INT, institution_name VARCHAR, institute_code VARCHAR, project_id INT, district_id INT, block_id INT,
  village VARCHAR, address VARCHAR, pincode INT, latitude NUMERIC, longitude NUMERIC, is_active SMALLINT, created_at TIMESTAMPTZ, updated_at TIMESTAMPTZ,
...
BEGIN
  RETURN QUERY SELECT i.institute_id, i.institution_name, i.institute_code, i.project_id, i.district_id, i.block_id,
    i.village, i.address, i.pincode, i.latitude, i.longitude, i.is_active, i.created_at, i.updated_at,
